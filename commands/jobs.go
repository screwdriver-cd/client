...
func JobsList(sdAPIClient *sd.ScrewdriverAPIDocumentation, c Context) (*v3.GetV3JobsOK, error) {
	if c.NArg() == 0 {
...
func JobByID(sdAPIClient *sd.ScrewdriverAPIDocumentation, c Context) (*v3.GetV3JobsIDOK, error) {
	id, err := getID(c)
	if err != nil {
		return nil, err
	}
